...
from wenet.transformer.convolution import ConvolutionModule,ConvolutionModule_PSA
...
from wenet.transformer.subsampling import Conv1dNoSubsampling
...
class BaseEncoder(torch.nn.Module):
    def __init__(
        ...
        #自己
            ...
            subsampling_class = Conv1dNoSubsampling
...
class ConformerEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        normalize_before: bool = True,
        concat_after: bool = False,   #  本来bool = False
        static_chunk_size: int = 0,
        use_dynamic_chunk: bool = False,
        global_cmvn: torch.nn.Module = None,
        use_dynamic_left_chunk: bool = False,
        ...
        convolution_PSA_layer = ConvolutionModule_PSA   #自己
        ...
        #         convolution_PSA_layer(
        #             *convolution_layer_args) if use_cnn_module and i == 0 else convolution_layer( *convolution_layer_args) ,
        #         dropout_rate,
        #         normalize_before,
        #         concat_after,
