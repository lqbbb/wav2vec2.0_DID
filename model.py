...
class SSLModel(nn.Module):
    def __init__(self,device):
        ...
        cp_path = '/home/lqb/project/SSL_Anti-spoofing-main/pre-trained_model_SSL/xlsr2_300m.pt'
    ...
    def extract_feat(self, input_data):
        ...
        if True:
            ...
            if input_data.ndim == 3:
                input_tmp = input_data[:, :, 0]  # [:, :, 0] 它是对多维数据的一种处理方式，代表了前两维全选，取其中的所有0号索引。
            else:
...
class Model(nn.Module):
    ...
    # def __init__(self, device):
        ...
        # self.out_layer = nn.Linear(5 * gat_dims[1], 6)   #改一下分类数  这里分六类,到数据哪里分四类?
