...
from wav2vec_ecapa import Model
...
def evaluate_accuracy(dev_loader, model, device,logger):
    ...
    with torch.no_grad():
        ...
        WriteConfusionSeaborn(
            confu_mat,
            hparams.lang,
            os.path.join("/home/lqb/project/SSL_Anti-spoofing-main", 'confmat_end.png')
        )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int, default=1234,
                        help='random seed (default: 1234)')  #1234    42
    
    parser.add_argument('--model_path', type=str,
                        default="models/model_wav2vec_ecapa_weighted_CCE_100_16_1e-06/epoch_16.pth", help='Model checkpoint')  #default=None
    parser.add_argument('--comment', type=str, default=None,
                        help='Comment to describe the saved model')
    # Auxiliary arguments  辅助参数
    parser.add_argument('--track', type=str, default='wav2vec_ecapa_relu_graph_selu_seed_1234',choices=['wav2Raw2','wav2vec_ecapa_relu_graph_selu_seed_1234'], help='task')
